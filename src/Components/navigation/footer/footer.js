                ...
                <Row>
                    <Col>
                        <p className="footer-text">Contact: 9936657710<br />Order: 9670300800, 9670400900, 9670800100 <br />
                            &copy; COPYRIGHT 2021 reserved by 0124hitesh/Fullstack-Project_2<br /><br/>
                            Made by <a style={{ display: "inline", float: "none" }} href="https://www.wordpress.com">Hitesh, Jai, Pranshul, Shubhang</a></p>
                    </Col>
                </Row>
            </Container>
        </footer>
